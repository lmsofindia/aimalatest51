...
$string['manage_groups'] = 'Ajustes del formato';
$string['format_settings'] = 'Ajustes del formato';
$string['section_appearance'] = 'Apariencia de los botones';
$string['display_options'] = 'Opciones de visualización';
$string['settings_saved'] = 'Configuración guardada correctamente';
$string['groups_saved'] = 'Configuración guardada correctamente';
$string['no_groups_configured'] = 'No hay grupos configurados. Primero actívalos en la administración del sitio del plugin.';
$string['invalid_color'] = 'Formato de color inválido. Use notación hexadecimal, por ejemplo: #FFFFFF o #FFF';
$string['backtocourse'] = 'Volver al curso';
$string['group_numbering_reset'] = 'Reiniciar conteo de secciones por grupo';
$string['group_numbering_reset_help'] = 'Si está activado, la numeración de las secciones reinicia en 1 al comenzar cada grupo (ej. 1-2-3 | 1-2-3). Si está desactivado, la numeración continúa a través de todos los grupos (ej. 1-2-3 | 4-5-6).';
$string['numbering_reset'] = 'Reiniciar por grupo (1-2-3 | 1-2-3)';
$string['numbering_continuous'] = 'Continua entre grupos (1-2-3 | 4-5-6)';