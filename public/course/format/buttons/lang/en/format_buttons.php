...
$string['manage_groups'] = 'Format settings';
$string['format_settings'] = 'Format settings';
$string['section_appearance'] = 'Button appearance';
$string['display_options'] = 'Display options';
$string['settings_saved'] = 'Settings saved successfully';
$string['groups_saved'] = 'Settings saved successfully';
$string['no_groups_configured'] = 'No groups are configured. Enable groups in the plugin site-administration settings first.';
$string['invalid_color'] = 'Invalid colour format. Use hexadecimal notation, e.g. #FFFFFF or #FFF';
$string['backtocourse'] = 'Back to course';
$string['group_numbering_reset'] = 'Reset section count per group';
$string['group_numbering_reset_help'] = 'When enabled, the section numbering restarts from 1 at each group (e.g. 1-2-3 | 1-2-3). When disabled, numbering continues across all groups (e.g. 1-2-3 | 4-5-6).';
$string['numbering_reset'] = 'Reset per group (1-2-3 | 1-2-3)';
$string['numbering_continuous'] = 'Continuous across groups (1-2-3 | 4-5-6)';
