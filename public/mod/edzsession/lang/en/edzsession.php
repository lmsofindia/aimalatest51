...
$string['provider_s3'] = 'Amazon S3';
$string['provider_s3_desc'] = 'Amazon S3 (or any S3-compatible store, e.g. Wasabi/MinIO). Dependency-free SigV4 multipart upload; playback via a CDN base URL (recommended) or presigned URLs.';
...
$string['privacy:attendancepath'] = 'EDZ Session attendance';
$string['privacy:metadata:attendanceraw'] = 'Raw participant segments captured from the meeting report before they are reconciled to Moodle users.';
$string['privacy:metadata:attendanceraw:name'] = 'The participant name reported by the meeting provider.';
$string['privacy:metadata:attendanceraw:email'] = 'The participant email reported by the meeting provider.';
$string['privacy:metadata:attendanceraw:registrantid'] = 'The registrant id reported by the meeting provider, if registration was used.';
