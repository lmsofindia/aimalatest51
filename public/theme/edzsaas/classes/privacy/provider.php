...
/**
 * Privacy Subsystem implementation for theme_edzsaas.
 *
...
namespace theme_edzsaas\privacy;
...
class provider implements
    ...
    public static function export_user_preferences(int $userid) {
        ...
        if (isset($draweropenindexpref)) {
            $preferencestring = get_string('privacy:drawerindexclosed', 'theme_edzsaas');
            if ($draweropenindexpref == 1) {
                $preferencestring = get_string('privacy:drawerindexopen', 'theme_edzsaas');
            }
        ...
        if (isset($draweropenblockpref)) {
            $preferencestring = get_string('privacy:drawerblockclosed', 'theme_edzsaas');
            if ($draweropenblockpref == 1) {
                $preferencestring = get_string('privacy:drawerblockopen', 'theme_edzsaas');
            }
            \core_privacy\local\request\writer::export_user_preference(
                'theme_edzsaas',
