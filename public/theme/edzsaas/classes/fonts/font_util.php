<?php
// This file is part of the theme_edzsaas plugin for Moodle - http://moodle.org/
//
...
namespace theme_edzsaas\fonts;

/**
 * Class font_util
 *
 * @package theme_edzsaas\fonts
 */
class font_util
{
    ...
    private static function list_fonts()
    {
        ...
        $configfonts = get_config('theme_edzsaas', "sitefonts");
