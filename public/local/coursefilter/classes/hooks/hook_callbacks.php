...
class hook_callbacks
{
     ...
     */
        public static function before_http_headers(before_http_headers $hook): void {
            ...
            $enabled = (int)get_config('local_coursefilter', 'enable');
            if (!$enabled) {
                return;
            }
            ...
            if ($SCRIPT === '/course/index.php') {
                ...
                $url = new \moodle_url('/local/coursefilter/', $params);
                redirect($url);
            }
        }
