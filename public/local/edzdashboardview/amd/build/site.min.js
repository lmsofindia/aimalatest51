        ...
        init: function() {
            ...
            function loadSiteData(range) {
                Ajax.call([{
                    ...
                    // Info Cards
                    // =========================
                    $('#card-active').text(resp.users?.active ?? 0);
                    $('#card-enrol').text(resp.enrolments?.[range] ?? 0);
                    $('#card-registered').text(resp.registered?.[range] ?? 0);
                    $('#card-webmobile').text(resp.webmobile ?? 0);
